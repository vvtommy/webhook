<?php
  ...
  $arrConfig['web_dev'] = array(
    ...
    'branch' => 'dev',
    'execute' => array(
      'cd /webserver/web_root/www.dev.weistreet.com/; git reset --hard HEAD 2>&1; git clean -f -d 2>&1; git pull 2>&1; mv index-product.php index.php; mkdir -p protected/runtime'
    )
  );
